// plugins/kubespin-ai-assistant/kubespin-ui/pages/ChatPage.sidebar.js
export const getChatPageSidebarConfig = ({
  addLog,
  session,
  ...
  topItems: [
    ...
    { type: "link", to: "/plugin/ai-assistant/chat", icon: "FaComments", text: "Chat", end: true },
