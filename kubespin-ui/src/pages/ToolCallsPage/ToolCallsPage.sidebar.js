// plugins/kubespin-ai-assistant/kubespin-ui/pages/ToolCallsPage.sidebar.js
export const getToolCallsPageSidebarConfig = ({
  addLog,
  session,
  ...
  topItems: [
    ...
    { type: "link", to: "/plugin/ai-assistant/tool-calls", icon: "FaTools", text: "Tool Calls", end: true },
